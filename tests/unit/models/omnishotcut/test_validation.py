...
from models.omnishotcut.validation import validate_shot_list, validate_shot_output
        ...
        result = validate_shot_output(
            {
                ...
                "shots": [
                    ...
                    },
                    {
                        ...
                        "start_ms": 5000,
                        "end_ms": 6000,
                    },  # gap: end 3000 → start 5000
                ],
            }
        )
        assert any("gap" in w.lower() or "not follow" in w.lower() for w in result["warnings"])
